...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li class="col-blue"><i class="material-icons">list</i>Liste anciens par zone</li>
            <li style="float: right;">                      
                   <a class="" href="report/imprimer_param.php?file=liste_fideles_anciens_zone&param=<?php echo $zone; ?>" title="Imprimer la liste des anciens de la zone" target="_blank"><i class="material-icons">print</i> Imprimer</a>
            </li>
        </ol>
    </div>
</div>
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                ...
                <div id="old_table" class="table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable tableau_dynamique"
                        ...
                        <tbody>
                            ...
                            while($liste=$selectAllFidele->fetch(PDO::FETCH_OBJ)){
                                ...
                                <tr>
                                    ...
                                    <td><a class="afficher" href="traitementListeAncienParZone.php?zone=<?php echo $liste->idzone; ?>" title="Afficher les fideles de cette zone"><?php echo $liste->nomzone; ?></a></td>
                     ...
                     <div align="center"><a class="btn btn-success" href="report/imprimer_param.php?file=Liste des fideles par zone&amp;param=<?php echo $zone; ?>" title="Imprimer la liste des anciens" target="_blank"><i class="material-icons">print</i> Imprimer</a>
                        <br>
                        <br>
                </div>
            </div>
...
<script>
    ...
    $('.col-red').on('click', function(e){
        ...
        var $a = $(this);
        var url = $a.attr('href');
        if(window.confirm('Voulez-vous supprimer cetf ancien?')){
            $.ajax(url, {
