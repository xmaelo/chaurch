    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li><i class="icon_document_alt"></i>Liste conseillers réorganisée par sexe</li>
                ...
                <div class=class="row">
                    <div class="col-lg-12">
                        <header class="panel-heading">
                            <span style="font-size: 1.5em;"><?php echo $total; ?> Conseillers enregistrés, reorganisés par sexe</span>
                            <!-- Module de recherche -->
                            <div class="form-group">
                                <input class="form-control" id="recherche" type="text" name="search" placeholder="Rechercher un conseillé">
                            </div>
                        </header>
                        ...
                        <div id="old_table" class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                while($liste=$selectAllFidele->fetch(PDO::FETCH_OBJ)){
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="form_liste_fidele_zone" href="traitementListeconseillerParZone?zone=<?php echo $liste->idzone; ?>" title="Afficher les fideles de cette zone"><?php echo $liste->nomzone; ?></a></td>
                            ...
                            <?php pagination($pageCourante, $nbDePage, "listeconseillerParSexe"); ?>

                            <div align="center"><a class="btn btn-success" href="report/imprimer.php?file=..." title="Imprimer la liste des conseiller" target="_blank"><i class="fa fa-print"></i> Imprimer</a></div>
                        </div>
                    </div>
                </div>
        </div>
