...
?>
    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    <li><i class="material-icons"></i>home<a href="index.php" class="col-blue"> Accueil</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <header class="panel-heading h4 text-center">
                                Assiduité des anciens aux Consistoires
                            </header>
                                ...
                                <table class="table table-bordered table-striped table-hover tableau_dynamique">
                                    ...
                                    <tbody>
                                        ...
                                        while($id=$res->fetch(PDO::FETCH_ASSOC)){
                                            ...
                                            $insert2 = "SELECT COUNT(fidele_idfidele)as nombre FROM  fideleconseil WHERE type = 'consistoire' AND lisible=1 AND fidele_idfidele=$identifiant0";
