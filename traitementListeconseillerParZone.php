...
if(isset($_SESSION['login'])){
    ...
    if(!has_Droit($idUser, "Lister fidele")){
        ...
        $selectAllFidele= $db->prepare("SELECT idpersonne, nom, prenom, sexe, idzone, nomzone, codefidele
                                        ...
                                        AND fidele.lisible=1 ORDER BY nomzone ASC");
...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li class="col-blue">list<i class="material-icons"></i><a class="afficher col-blue" href="listeAnciens.php">Liste Conseillers</a></li>
            <li class="col-blue"><i class="material-icons">list</i>Liste conseillers par zone</li>
            <li style="float: right;">                      
                   <a class=""  href="report/imprimer_param.php?file=liste_fideles_conseillers_zone&param=<?php echo $zone; ?>" title="Imprimer la liste des conseillers de la zone" target="_blank">
    ...
    <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                <div class="card">
                   ...
                   Liste des Conseillers dans la zone 
                         ...
                         <tbody>   
                            ...
                            while($liste=$selectAllFidele->fetch(PDO::FETCH_OBJ)){
                                ...
                                <tr>
                                    ...
                                    <td><a class="afficher" href="traitementListeconseillerParSexe.php?sexe=<?php echo $liste->sexe; ?>" title="Afficher les fidèle de <?php echo $liste->sexe; ?>"><?php echo $liste->sexe; ?></a></td>
                                    <td><a class="afficher" href="traitementListeconseillerParZone.php?zone=<?php echo $liste->idzone; ?>" title="Afficher les fideles de cette zone"><?php echo $liste->nomzone; ?></a></td>
                                    ...
                                    <td>
                                            ...
                                            <a class="col-grenn afficher" href="modifierFidele.php?id=<?php echo $liste->idpersonne; ?>" title="Modifier" <?php if(!has_Droit($idUser, "Modifier un fidele") || (date('Y') != $annee)){echo 'hidden';}else{echo "";} ?>><i class="material-icons">border_color</i></a>
                    ...
                    <br>
                    <div align="center">
            <a class="btn btn-success" href="report/imprimer_param.php?file=liste_fideles_conseillers_zone&param=<?php echo $zone; ?>" title="Imprimer la liste des conseillers de la zone" target="_blank"><i class="material-icons">print</i> Imprimer</a>
            </div>
            <br>
                </div>
            </div>
