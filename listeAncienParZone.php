    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li><i class="icon_document_alt"></i>Liste anciens reorganisés par zone</li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <header class="panel-heading">
                            <span style="font-size: 1.5em;"><?php echo $total; ?> Anciens enregistrés, reorganisés par zone</span>
                            <!-- Module de recherche -->
                        ...
                        <div id="old_table" class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                while($liste=$selectAllFidele->fetch(PDO::FETCH_OBJ)){
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="form_liste_fidele_zone" href="traitementListeAncienParZone.php?zone=<?php echo $liste->idzone; ?>" title="Afficher les fideles de cette zone"><?php echo $liste->nomzone; ?></a></td>
                            ...
                            <?php pagination($pageCourante, $nbDePage, "listeAncienParZone"); ?>
        ...
        if(window.confirm('Voulez-vous supprimer cet ancien?')){
            $.ajax(url, {
                ...
                error: function(){
                    ...
                    alert("Une erreur est survenue lors de la suppresion de cet ancien");
                }
            });
        }
    });
