...
if(isset($_SESSION['login'])){
    ...
    if(!has_Droit($idUser, "Lister fidele")){
        ...
        $selectNombreFidele = $db->prepare("SELECT COUNT(idfidele) AS nbretotalfidele
                                            ...
                                            AND fidele.lisible = 1 ORDER BY personne.zone_idzone");
        ...
        $selectAllFidele= $db->prepare("SELECT idpersonne, nom, prenom, sexe, idzone, nomzone, codefidele
                                        ...
                                        AND personne.lisible=1 AND zone.lisible = true
                                        AND statut='conseiller'
                                        AND fidele.lisible=1 ORDER BY personne.zone_idzone ASC LIMIT $premierElementDeLaPage, $nbeParPage");
    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li><i class="icon_document_alt"></i><a id="listeF" href="listeconseilles.php">Liste Conseillers</a></li>
                <li><i class="icon_document_alt"></i>Liste  des conseillers reorganisée par zone</li>
                <li style="float: right;">                      
                   <a class="" href="report/imprimer_param.php?file=liste_fideles_statut&param=CONSEILLER" title="Imprimer la liste des conseillers" target="_blank"><i class="fa fa-print"></i> Imprimer</a>
                </li>
            </ol>
        </div>
    </div>
                ...
                <div class=class="row">
                    <div class="col-lg-12">
                        <header class="panel-heading">
                            <span style="font-size: 1.5em;"><?php echo $total; ?> Conseillers enregistrés, reorganisés par zone</span>
                            <!-- Module de recherche -->
                        ...
                        <div id="result"> </div>
                        <div id="old_table" class="table-responsive table-hover">
                            <table class="table table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <th><i class="icon_calendar"></i><a class="ordre_rangement"  href="listeconseillerParSexe.php" title="réorganiser par sexe">Sexe</a></th>
                                    <th><i class="icon_pin_alt"></i><a href="listeconseillerParZone.php" class="ordre_rangement" title="Réorganiser par zone">Zone</a></th>
                                ...
                                while($liste=$selectAllFidele->fetch(PDO::FETCH_OBJ)){
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="listeSexe" href="traitementListeconseillerParSexe.php?sexe=<?php echo $liste->sexe; ?>" title="Afficher les fidèle de <?php echo $liste->sexe; ?>"><?php echo $liste->sexe; ?></a></td>
                                        <td><a class="form_liste_fidele_zone" href="traitementListeconseillerParZone.php?zone=<?php echo $liste->idzone; ?>" title="Afficher les fideles de cette zone"><?php echo $liste->nomzone; ?></a></td>
                                        ...
                                        <td width="15%">
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-danger" href="supprimerFidele.php?code=<?php echo $liste->idpersonne; ?>" title="Supprimer" <?php if(!has_Droit($idUser, "Supprimer fidele")){echo 'disabled';}else{echo "";} ?>><i class="icon_close_alt2"></i></a>
                                            </div>
                                        </td>
                            ...
                            <?php pagination($pageCourante, $nbDePage, "listeconseillerParZone"); ?>

                            <div align="center"><a class="btn btn-success" href="report/imprimer.php?file=Liste des fideles par zone" title="Imprimer la liste des fidèles" target="_blank"><i class="fa fa-print"></i> Imprimer</a>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $('.btn-danger').on('click', function(e){
        ...
        var $a = $(this);
        var url = $a.attr('href');
        if(window.confirm('Voulez-vous supprimer ce conseillé?')){
            $.ajax(url, {
                ...
                error: function(){
                    ...
                    alert("Une erreur est survenue lors de la suppresion de ce conseillé");
                }
            });
        }
    });
