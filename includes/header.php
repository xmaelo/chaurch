  <?php
    ...
    try{
      require_once('connexionbd.php');
        ...
        $param = $db->prepare("SELECT * from parametre where idparametre = 1");
          $param->execute();
...
<head>
    ...
    .iconposition{
        ...
        .themes_church_sidbar{
        background-image: url('themes_church_sidbar/theme1.jpg');
...
<script src="js/ckeditor/ckedito.js"></script>
    ...
    <script src="js/ckeditor/ckeditor.js"></script>
        ...
        <!-- Jquery DataTable Plugin Js PRECISEZ AJOUTER -->
