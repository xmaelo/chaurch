...
if(isset($_SESSION['login'])){
    ...
    if(!has_Droit($idUser, "Consulter participation")){
        ...
        if(isAjax()){
            ...
            if(isset($_POST['contribution1']) && isset($_POST['min'])&& isset($_POST['max'])){
                $contribution=$_POST['contribution1'];
                $min=$_POST['min'];
                $max=$_POST['max'];


                $ps=$db->prepare("SELECT *
                                    FROM personne, fidele, contributionfidele, zone
                                    ...
                                    AND zone.lisible=1
                                    AND typecontribution='$contribution'
                                    AND contributionfidele.date BETWEEN '$min' AND '$max'
                                    ORDER BY nom");
                $ps->execute();
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <header class="panel-heading">
                                <span style="font-size: 1.5em;"> Liste des <?php echo $contribution; ?> réalisé(e)s entre le <?php echo $min; ?> et le <?php echo $max; ?> </span>
                            </header>
