    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12">
            <ol class="breadcrumb">
                ...
                <li class="col-blue"><i class="material-icons"></i> Bilan période I</li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <header class="panel-heading h4 text-center">
                            <span style="font-size: 1.5em;">Contributions enregistrées le <?php echo $date_jour; ?>: Période I </span>
                        </header>
                        <div id="result"> </div>
                        <div id="old_table" class="table-responsive">
                            ...
                            <table class="table table-bordered table-striped table-hover tableau_dynamique">
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="material-icons iconposition"></i>Code</th>
                                        <th><i class="material-icons iconposition"></i>Noms et prenoms</th>
                                        <th><i class="material-icons iconposition"></i>Statut paroissial</th>
                                        <th><i class="material-icons iconposition"></i>Sainte Cène</th>
                            ...
                            <table class="table table-bordered table-striped table-hover tableau_dynamique">
                                <caption style="font-size: 1.5em; font-weight: bold;text-align: center">Dépense de la période I</caption>
                                <thead>
                                    <tr>
                                        <th><i class="material-icons iconposition"></i>Numéro</th>
                             ...
                             <caption style="font-size: 1.5em; font-weight: bold;text-align: center">Statistiques de la période I</caption>
                                      <thead>
                                      <tr>
                                          <th>CATEGORIE</th>
                                          <th>EFFECTIFS</th>
                           ...
                           <div align="center">   
                                <a class="btn btn-success h3" href="report/imprimer_param.php?file=bilanperiode1&amp;param=<?php echo $date_jour; ?>" title="Imprimer le bilan la période I" target="_blank"><i class="material-icons">print</i> Imprimer</a>                              
                           </div>                        
                    </div>
                </div>
        </div>
