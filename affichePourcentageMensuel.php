                    ...
                    <div class="row card">
                        <div class="col-lg-12">
                            <header class="panel-heading h4 text-center">
                                Assiduité des anciens aux Conseils mensuels
                            </header>
                                    ...
                                    <tfoot>
                                     ...
                                     <tbody>   
                                        ...
                                        while($id=$res->fetch(PDO::FETCH_ASSOC)){
                                            ...
                                            $insert2 = "SELECT COUNT(fidele_idfidele)as nombre FROM  fideleconseil WHERE type = 'conseil mensuel' AND lisible=1 AND fidele_idfidele=$identifiant0";
                                            ...
                                            $taux=($identifiant3==0 ? 0 : number_format($identifiant3 * 100/($identifiant4==0?1:$identifiant4), 2));
