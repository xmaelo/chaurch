                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <header class="panel-heading h4 text-center">
                                Assiduité des anciens aux Conseils elargis
                            </header>
                            <div id="old_table" class="table-responsive">
                                <table class="table table-bordered table-striped table-hover tableau_dynamique">
                                    ...
                                    while($id=$res->fetch(PDO::FETCH_ASSOC)){
                                        ...
                                        $insert2 = "SELECT COUNT(fidele_idfidele)as nombre FROM  fideleconseil WHERE type = 'conseil elargi' AND lisible=1 AND fidele_idfidele=$identifiant0";
